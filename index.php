...
<head>
    ...
    <style>
        ...
        .container { 
            ...
            text-align: center; width: 85%; max-width: 400px; color: white; 
        }
        /* تنسيق الحقل ليتناسب مع مكتبة الأعلام */
        .iti { width: 100%; margin: 15px 0; display: block; }
        input { width: 100%; padding: 12px; border-radius: 5px; border: none; box-sizing: border-box; }
